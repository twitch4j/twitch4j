...
public class SimpleHttpClient {
	...
	/**
	 * Obtain a {@link twitch4j.common.rest.http.client.SimpleHttpClient} builder.
	 *
	 * @return a builder
	 */
	 ...
	 * {@link twitch4j.common.rest.http.client.ExchangeFilter},
	...
	/**
	 * A mutable builder for a {@link twitch4j.common.rest.http.client.SimpleHttpClient}.
	 */
	public interface Builder {
		...
		/**
		 * Configure the {@link twitch4j.common.rest.http.WriterStrategy} to use. It will be added to the list of strategies.
		 *
		...
		/**
		 * Configure the {@link twitch4j.common.rest.http.ReaderStrategy} to use. It will be added to the list of strategies.
		 *
		...
		/**
		 * Build the {@link twitch4j.common.rest.http.client.SimpleHttpClient} instance.
		 *
		 * @return a client
		 */
