...
import twitch4j.stream.rest.http.*;
...
public class CommonUtils {
	...
	/**
	 * Getting properties from generated <code>git.properties</code> generated by <a href="https://plugins.gradle.org/plugin/com.gorylenko.gradle-git-properties">Gradle Git Properties Plugin</a>.
	 * @return a Properties from <code>git.properties</code> file.
	 */
	public static Properties getProperties() {
		Properties properties = new Properties();
		try {
			properties.load(ClassLoader.getSystemClassLoader().getResourceAsStream("git.properties"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		return properties;
