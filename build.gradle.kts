		...
		withType<Javadoc> {
			options {
				...
				links(
					...
					"https://javadoc.io/doc/io.github.openfeign/feign-slf4j/12.0",
					"https://javadoc.io/doc/io.github.openfeign/feign-okhttp/12.0",
					"https://javadoc.io/doc/io.github.openfeign/feign-jackson/12.0",
					"https://javadoc.io/doc/io.github.openfeign/feign-hystrix/12.0",
...
subprojects {
	...
	dependencies {
		constraints {
			...
			// HTTP Client
			api(group = "io.github.openfeign", name = "feign-slf4j", version = "11.112.0")
			api(group = "io.github.openfeign", name = "feign-okhttp", version = "11.112.0")
			api(group = "io.github.openfeign", name = "feign-jackson", version = "11.112.0")
			api(group = "io.github.openfeign", name = "feign-hystrix", version = "11.112.0")
