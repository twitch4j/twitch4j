...
subprojects {
	...
	dependencies {
		...
		// Logging
		api(group = "org.slf4j", name = "slf4j-api", version = "2.0.14")
		...
		withType<Javadoc> {
			options {
				...
				links(
						...
						"https://javadoc.io/doc/org.slf4j/slf4j-api/2.0.14",
						...
						"https://javadoc.io/doc/org.apache.commons/commons-lang3/3.16.0",
