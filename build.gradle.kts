...
subprojects {
	...
	dependencies {
		...
		// - Logging
		testImplementation(group = "ch.qos.logback", name = "logback-classic", version = "1.3.6")
	}
		...
		withType<Javadoc> {
			options {
				...
				links(
						...
						"https://javadoc.io/doc/io.github.openfeign/feign-slf4j/12.2",
						"https://javadoc.io/doc/io.github.openfeign/feign-okhttp/12.2",
						"https://javadoc.io/doc/io.github.openfeign/feign-jackson/12.2",
						"https://javadoc.io/doc/io.github.openfeign/feign-hystrix/12.2",
