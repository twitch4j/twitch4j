...
//	}
	...
	dependencies {
		constraints {
			...
			// Event Dispatcher
			api(group = "com.github.philippheuer.events4j", name = "events4j-core", version = "0.9.4")
			api(group = "com.github.philippheuer.events4j", name = "events4j-handler-simple", version = "0.9.4")
			api(group = "com.github.philippheuer.events4j", name = "events4j-handler-reactor", version = "0.9.4")
			api(group = "com.github.philippheuer.events4j", name = "events4j-handler-spring", version = "0.9.4")
