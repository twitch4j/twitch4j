		...
		withType<Javadoc> {
			options {
				...
				links(
					...
					"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-databind/2.13.4.2",
...
subprojects {
	...
	dependencies {
		...
		// Jackson BOM
		api(platform("com.fasterxml.jackson:j2.13.4.20221013:2.13.4"))
