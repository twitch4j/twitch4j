...
subprojects {
	...
	dependencies {
		constraints {
			...
			// Rate Limiting
			api(group = "com.bucket4j", name = "bucket4j_jdk8-core", version = "8.7.1")
		...
		withType<Javadoc> {
			options {
				...
				links(
						...
						"https://javadoc.io/doc/com.bucket4j/bucket4j_jdk8-core/8.7.1",
						...
						"https://javadoc.io/doc/org.slf4j/slf4j-api/2.0.11",
