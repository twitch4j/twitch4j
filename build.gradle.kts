...
subprojects {
	...
	dependencies {
		...
		// - Logging
		testImplementation(group = "ch.qos.logback", name = "logback-classic", version = "1.5.20")
	}
		...
		withType<Javadoc> {
			options {
				...
				links(
						...
						"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-databind/2.20.0",
						"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-core/2.20.0",
