...
subprojects {
	...
	dependencies {
		constraints {
			// Annotations
			api(group = "org.jetbrains", name = "annotations", version = "25.0.0")
			...
			// HTTP Client
			api(group = "io.github.openfeign", name = "feign-slf4j", version = "13.4")
			api(group = "io.github.openfeign", name = "feign-okhttp", version = "13.4")
			api(group = "io.github.openfeign", name = "feign-jackson", version = "13.4")
			api(group = "io.github.openfeign", name = "feign-hystrix", version = "13.4")
		...
		// - Logging
		testImplementation(group = "ch.qos.logback", name = "logback-classic", version = "1.5.9")
	}
		...
		withType<Javadoc> {
			options {
				...
				links(
						...
						"https://javadoc.io/doc/io.github.openfeign/feign-slf4j/13.4",
						"https://javadoc.io/doc/io.github.openfeign/feign-okhttp/13.4",
						"https://javadoc.io/doc/io.github.openfeign/feign-jackson/13.4",
						"https://javadoc.io/doc/io.github.openfeign/feign-hystrix/13.4",
						"https://javadoc.io/doc/org.slf4j/slf4j-api/2.0.16",
						"https://javadoc.io/doc/com.neovisionaries/nv-websocket-client/2.14",
						"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-databind/2.18.0",
						"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-core/2.18.0",
						"https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-annotations/2.18.0",
