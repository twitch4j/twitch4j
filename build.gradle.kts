...
subprojects {
	...
	dependencies {
		constraints {
			...
			// Rate Limiting
			api(group = "com.bucket4j", name = "bucket4j_jdk8-core", version = "8.9.0")
		...
		// - Logging
		testImplementation(group = "ch.qos.logback", name = "logback-classic", version = "1.5.2")
	}
		...
		withType<Javadoc> {
			options {
				...
				links(
						...
						"https://javadoc.io/doc/com.bucket4j/bucket4j_jdk8-core/8.9.0",
